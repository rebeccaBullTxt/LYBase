...
- (NSString *)httpParameterNoSS {
    return [self stringWithFormatter:@"%m-%d %H:%M"];
}
- (NSString *)httpParameterStringNoSS {
    return [self stringWithFormatter:@"%Y-%m-%d %H:%M"];
}
- (NSString *)hhMmSsStringNoSS {
    return [self stringWithFormatter:@"%H:%M"];
}

- (NSString *)hhMmSsString {
    return [self stringWithFormatter:@"%H:%M:%S"];
}
