...
/**
 ...
 @param message message
 */
extern void ShowCustomMessage(UIView *view,NSString *message);
 ...
 */
extern void ShowDefaultSuccessView(NSString *message,void(^completed)(void));
...
/**
 ...
 @param completed  完成回调
 */
extern void ShowSuccessView(UIView *view,NSString *message,void(^completed)(void));
...
/**
 ...
 @param completed  完成回调
 */
extern void ShowDefaultErrorView(NSString *message,void(^completed)(void));
...
/**
 ...
 @param completed  完成回调
 */
extern void ShowErrorView(UIView *view,NSString *message,void(^completed)(void));
...
/**
 ...
 author: yuan
 */
extern void ShowGifDefaultLoadingView();

/**
 Gif自定义持续加载框
 author: yuan
 */
extern void ShowGifCustomLoadingView(UIView *view);
